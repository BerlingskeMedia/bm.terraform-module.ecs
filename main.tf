...
locals {
  ...
  external_alb_output_map = {
    "dns_endpoint"              = var.alb_external_enabled ? module.alb_default_external.alb_dns_name : ""
    "https_listener_arn"        = var.alb_external_enabled ? module.alb_default_external.https_listener_arn : ""
  ...
  internal_alb_output_map = {
    "dns_endpoint"              = var.alb_internal_enabled ? module.alb_default_internal.alb_dns_name : ""
    "https_listener_arn"        = var.alb_internal_enabled ? module.alb_default_internal.https_listener_arn : ""
